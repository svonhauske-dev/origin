...
export const themes = {
  ...
  dark: {
    ...
    text: {
      ...
      onAccent:  "#1A1A1A",
      onDanger:  "#FFFFFF",
      faint:     "rgba(244,246,248,0.3)",
    },
    accent: {
      default: "#F4F6F8",
      hover:   "#FFFFFF",
      subtle:  "#2A2A2A",
      border:  "rgba(244,246,248,0.3)",
    },
    border: {
      subtle: "#303030",
      strong: "#D4D8DC",
    ...
    status: {
      ...
      danger:           "#C0544A",
      dangerSubtle:     "#2A1A1A",
      dangerBorder:     "rgba(192,84,74,0.3)",
      warning:          "#C09650",
      warningSubtle:    "#2A2010",
      missedBorder:     "rgba(192,150,80,0.35)",
      missedBg:         "rgba(192,150,80,0.08)",
      missedHover:      "rgba(192,150,80,0.12)",
      missedBadgeBg:    "#2A2010",
      missedBadgeColor: "#C09650",
      nowBorder:        "rgba(244,246,248,0.35)",
      nowBg:            "rgba(244,246,248,0.06)",
      nowHover:         "rgba(244,246,248,0.10)",
      nowBadgeBg:       "rgba(244,246,248,0.14)",
    },
    gradients: {
      bg: "linear-gradient(180deg,#1A1A1A 0%,#1C1C1C 50%,#1F1F1F 100%)",
    },
  },
