  ...
  primitives: {
    ...
    Button: {
      ...
      variants: [
        ...
        { name: 'pill (inactive)',     props: { variant: 'pill', active: false, children: 'Oral' } },
        { name: 'pill (active)',       props: { variant: 'pill', active: true,  children: 'Oral' } },
        { name: 'pill (solid active)', props: { variant: 'pill', active: true, solidActive: true, children: 'Oral' } },
