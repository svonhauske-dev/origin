...
**0. Mobile-only verification pass (~1h).**
...
**0a. Portfolio link update at vonhauske.design/origin-app.**
Update the portfolio entry to reflect the May 20 mobile-only pivot, the `/design-system` URL, and any copy changes needed.
